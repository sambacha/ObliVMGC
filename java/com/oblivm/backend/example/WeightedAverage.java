...
public class WeightedAverage {
    ...
    public static class Generator<T> extends GenRunnable<T> {
        ...
        public void prepareInput(CompEnv<T> gen) {
            int x1 = Integer.parseInt(args[0]) * a1;
            int x2 = Integer.parseInt(args[1]) * a2;
    ...
    public static class Evaluator<T> extends EvaRunnable<T> {
        ...
        public void prepareInput(CompEnv<T> eva) {
            int x1 = Integer.parseInt(args[0]) * a3;
            int x2 = Integer.parseInt(args[1]) * a3;
            inputA = eva.inputOfAlice(Utils.fromInt(new Integer(x1 + x2), 32));
            eva.flush();
